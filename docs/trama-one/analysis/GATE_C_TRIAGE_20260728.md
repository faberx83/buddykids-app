...
8. Rimane da investigare: TC-160 (Indietro, possibile regressione bug #22), TC-N98/N99, TC-119/153/N24 (Cluster C, testi/href da aggiornare), Cluster F (TC-508, guard silenzioso in `cleanup-test-data.mjs`), resto della lista Cluster G (TC-176, TC-026, TC-102, TC-138, TC-186, TC-075, TC-200/127, TC-178/163, TC-N300, TC-N73/76/80, TC-263/N14, TC-N108/112/114, TC-N10, TC-N296, TC-166), "did not run" (Obiettivo 4).
