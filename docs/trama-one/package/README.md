...
**IMPORTANTE (08/09/2026)**: questo package resta fermo al 06/08/2026 (v4). Per una fotografia dello stato REALE ad oggi — oltre un mese di lavoro successivo, incluse tre aree strutturalmente cambiate (Dashboard Gestore, "Il mio centro", onboarding) non ancora nemmeno deployate in produzione — leggere **`TRAMA_CURRENT_STATE_ADDENDUM_2026-09-08.md`** insieme a questo package, non al suo posto: l'addendum non ricalcola le metriche/i verdetti sotto, li integra con un changelog verificabile e una mappa esplicita di quali dei documenti elencati sotto sono oggi incompleti (mai falsi) di conseguenza.
