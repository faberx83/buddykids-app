...
| PT-MVP-08 | Disponibilità strutturata | `AvailabilityCalendar.tsx`, `lib/availability-bulk.ts` | migration_18 (nessuna nuova migrazione: colonne già esistenti) | availability spec + `tests/gestore/calendario-bulk.spec.ts` (8 test puri PASS) + 3 test E2E live PASS (TC-N634/635/636) | Sì | **LIVE** — OD-02 chiuso (decisione A, commit `16b0527`, deploy verificato `24464bf`), verificato dal vivo da Fabrizio |
