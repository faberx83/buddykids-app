...
import { ParentAttendanceReport } from "@/lib/data/attendance-report";

// TRAMA ONE (24/08/2026) — estratto da app/(main)/presenze/page.tsx per
...
export default function PresenzeView({
  ...
  return (
    <div className="animate-fade-in">
      ...
      <PageHeader title="Le presenze" showBrandIcon={showBrandIcon} />
