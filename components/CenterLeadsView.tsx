...
// delle proprie segnalazioni di centri non iscritti (J11).
//
// TRAMA ONE (24/08/2026) — estratto da app/(main)/center-leads/page.tsx per
...
export default async function CenterLeadsView({ showBrandIcon }: { showBrandIcon?: boolean }) {
  const leads = await getMyCenterLeads();

  return (
    <div className="animate-fade-in">
      <PageHeader title="I tuoi suggerimenti" showBrandIcon={showBrandIcon} />
